...
const WavyBackground = () => {
  return (
    <div className="bg-wrapper">
      ...
      {/* THE MULTI-LAYER WAVE STACK */}
      <div className="wave-container !-bottom-24">
        {/* LIGHT WAVE (TOP - 1:3 Distribution) */}
        <svg viewBox="0 0 1440 320" className="wave wave-light">
          <path 
        ...
        <svg viewBox="0 0 1440 320" className="wave wave-dark">
          <path 
            fill="#F8F6F1"
        ...
        <svg viewBox="0 0 1440 320" className="wave wave-accent-blue">
          <path 
